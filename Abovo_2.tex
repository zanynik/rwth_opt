...
The effect is no two ULDs run in parallel. For the objective funciton we need to know the ULD starting times. Here, starting time of ULD i is $t_{i} = \sum_{t=0}^{T-h_{j}+1} t x_{it} $.
...
$\newline$
 ...
 ${\color{black}{s_{i}}}$ + ${\color{black}{t_{j}}}$ ${\color{black}{x_{ij}^{t}}}$ + ${\color{black}{h_{j}}}$ ${\color{black}{x_{ij}^{t}}}$
