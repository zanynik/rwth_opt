...
\begin{equation*} ${\color{black} Shipment l}$ {}  \in {}  ${\color{black}L}$ {} = {} ${\color{black}\{$L_{1}$,$L_{2}$,$L_{3}$,...,$L_{i}$\}}$ \end{equation*} %newly_added_by_ilkim% 
...
When considering about the journey of shipments, each ULD i has $l \in L_{i}$ shipments. If ULD i is assigned at time t, all shipments are assigned at time t. %newly_added_by_ilkim%
